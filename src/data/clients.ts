...
export const clients: Client[] = [
  { name: 'Al Ahly Sabbour', logo: 'al-ahly-sabbour.png', nameAr: 'الأهلي صبور', sector: { en: 'Real estate development', ar: 'التطوير العقاري' }, hex: '8A6D3B', mono: 'AS' },
  { name: 'Redcon Construction', logo: 'redcon.png', nameAr: 'ريدكون للإنشاءات', sector: { en: 'Construction', ar: 'الإنشاءات' }, hex: '1B1B1B', mono: 'RC' },
  { name: 'QNB', logo: 'qnb.png', nameAr: 'بنك قطر الوطني', sector: { en: 'Banking', ar: 'البنوك' }, hex: '6B1F5E', mono: 'QNB' },
  { name: 'Mashreq', logo: 'mashreq.png', nameAr: 'المشرق', sector: { en: 'Banking', ar: 'البنوك' }, hex: 'F26522', mono: 'MQ' },
  { name: 'Faisal Islamic Bank', logo: 'faisal-islamic-bank.png', nameAr: 'بنك فيصل الإسلامي', sector: { en: 'Banking', ar: 'البنوك' }, hex: '0E7A3E', mono: 'FIB' },
  { name: 'Hikma', logo: 'hikma.png', nameAr: 'حكمة', sector: { en: 'Pharmaceuticals', ar: 'الأدوية' }, hex: 'E4002B', mono: 'HK' },
